export function AnimatedName() {
  return (
    <>
      <h3 className='bg-gradient-to-br from-zinc-800 via-zinc-500 to-zinc-300 bg-clip-text text-4xl font-bold text-transparent shadow-foreground drop-shadow-md min-[320px]:text-6xl min-[460px]:text-7xl md:text-[5rem] lg:text-8xl xl:text-[6.5rem] 2xl:text-[8rem]'>
        Ethan G.
      </h3>
