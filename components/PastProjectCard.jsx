  ...
  return (
    <div className="group transition-all duration-300 ease-in-out">
      <a
        ...
        className="mb-0.5 line-clamp-1 text-center leading-tight font-semibold tracking-tight group-hover:text-blue-400 group-focus:text-blue-600 md:text-base xl:text-lg 2xl:text-xl dark:group-hover:text-blue-600 dark:group-focus:text-blue-400"
      >
        {project.title}
